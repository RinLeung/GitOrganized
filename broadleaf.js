...
jQuery(document).ready(function( $ ) {
	...
	$('.burger-i>a').click(function(){
		...
		$('.main-navigation-ul li > .sub-menu').css({"display": "block", "width":"auto" });
			...
			$('body').prepend('<style class="opbm-style">@media (min-width:1141px){.main-navigation-ul li.has-mega-menu>ul.sub-menu{top:20px;}.mk-svg-icon{position:relative; z-index:999;}.header-logo{z-index:-1}</style>');
			i++;
		}
		else {
